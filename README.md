...
> **Note:** The provided `environment.yml` contains Windows‑specific packages (e.g., `win-64``). If you are on Linux or macOS, you may need to adjust the environment or create a new one manually.
